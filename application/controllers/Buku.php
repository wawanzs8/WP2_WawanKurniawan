...
'required', [ 
      ...
      {
        $data['judul'] = 'Ubah Data Ktegori';
        $data['user'] = $this->ModelUser->celData(['email'=> $this->session->userdata('email')])->row_array();
        $data['kategori'] = $this->ModelBuku->kategoriWhere(['id' => $this->segment(3)])->result_array();
