...
<?= $judul . ' ' . $b['judul_buku']; ?> ?');" class="badge badge-danger"><i class="fas fa-trash"></i>
Hapus</a>
</td> -->
</tr>
<?php } ?>
...
<button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas faban"></i> Close</button>
